...
if TYPE_CHECKING:
    ...
    from b1sl.b1sl.models._generated.entities.purchasing import (
        LandedCost,
        LandedCostsCode,
    )
    ...
    CorrectionPurchaseInvoiceReversal = (
        Document  # From: CorrectionPurchaseInvoiceReversal
    )
    ...
    IntegrationPackagesConfigure = (
        IntegrationPackageConfigure  # From: IntegrationPackagesConfigure
    )
    ...
    SalesOpportunityCompetitorsSetup = (
        SalesOpportunityCompetitorSetup  # From: SalesOpportunityCompetitorsSetup
    )
    SalesOpportunityInterestsSetup = (
        SalesOpportunityInterestSetup  # From: SalesOpportunityInterestsSetup
    )
    SalesOpportunityReasonsSetup = (
        SalesOpportunityReasonSetup  # From: SalesOpportunityReasonsSetup
    )
    SalesOpportunitySourcesSetup = (
        SalesOpportunitySourceSetup  # From: SalesOpportunitySourcesSetup
    )
    ...
    ValueMappingCommunication = (
        ValueMappingCommunicationData  # From: ValueMappingCommunication
    )
...
# Entity names resolvable through __getattr__ (lazily built on first access)
...
_ALIASES = {
    "AssetCapitalization": "AssetDocument",
    "AssetCapitalizationCreditMemo": "AssetDocument",
    "AssetManualDepreciation": "AssetDocument",
    "AssetRetirement": "AssetDocument",
    ...
    "DownPayment": "Document",
    "Draft": "Document",
    "EmployeeRolesSetup": "EmployeeRoleSetup",
    "EmployeesInfo": "EmployeeInfo",
    "FormPreference": "ColumnPreferences",
    "GoodsReturnRequest": "Document",
    "IncomingPayment": "Payment",
    "IntegrationPackagesConfigure": "IntegrationPackageConfigure",
    "InventoryCycle": "InventoryCycles",
    "InventoryGenEntry": "Document",
    "InventoryGenExit": "Document",
    "InventoryTransferRequest": "StockTransfer",
    "Invoice": "Document",
    "ItemGroup": "ItemGroups",
    "NCMCodesSetup": "NCMCodeSetup",
    "OccurrenceCode": "OccurenceCode",
    "Order": "Document",
    "PaymentDraft": "Payment",
    "ProjectManagement": "PM_ProjectDocumentData",
    "ProjectManagementTimeSheet": "PM_TimeSheetData",
    "PurchaseCreditNote": "Document",
    "PurchaseDeliveryNote": "Document",
    "PurchaseDownPayment": "Document",
    "PurchaseInvoice": "Document",
    "PurchaseOrder": "Document",
    "PurchaseQuotation": "Document",
    "PurchaseRequest": "Document",
    "PurchaseReturn": "Document",
    "Quotation": "Document",
    "ReportFilter": "TaxReportFilter",
    "Return": "Document",
    "ReturnRequest": "Document",
    "SalesOpportunity": "SalesOpportunities",
    "SalesOpportunityCompetitorsSetup": "SalesOpportunityCompetitorSetup",
    "SalesOpportunityInterestsSetup": "SalesOpportunityInterestSetup",
    "SalesOpportunityReasonsSetup": "SalesOpportunityReasonSetup",
    "SalesOpportunitySourcesSetup": "SalesOpportunitySourceSetup",
    "SelfCreditMemo": "Document",
    "SelfInvoice": "Document",
    "StockTransferDraft": "StockTransfer",
    "TaxCodeDeterminationsTCD": "TaxCodeDeterminationTCD",
    "TransportationDocument": "TransportationDocumentData",
    "UserFieldsMD": "UserFieldMD",
    "ValueMappingCommunication": "ValueMappingCommunicationData",
    "VendorPayment": "Payment",
    "WitholdingTaxDefinition": "WTDCode",
}


def __getattr__(name: str) -> Any:
    """Resolve an entity class lazily, building its pydantic schema on first use."""
    target = _ALIASES.get(name, name)
    if target not in _ENTITY_NAMES:
        raise AttributeError(f"module {__name__!r} has no attribute {name!r}")
    from b1sl.b1sl.models._generated import entities as _gen

    model = _gen.resolve(target)  # override-aware + lazily schema-built
    globals()[name] = model  # cache: subsequent accesses bypass __getattr__
    return model


def __dir__() -> list[str]:
    return sorted(set(globals()) | _ENTITY_NAMES | set(_ALIASES))


def preload() -> None:
    """Eagerly build every entity model (several GiB of RSS, ~10s+ of CPU).

    Opt-in warm-up for deployments that prefer paying the full schema-build
    cost once at startup instead of lazily per entity.
    """
    from b1sl.b1sl.models._generated import entities as _gen
