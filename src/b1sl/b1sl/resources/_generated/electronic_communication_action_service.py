...
class ElectronicCommunicationActionService(GenericResource[Any]):
    ...
    def afe_fce_ap_check_ecm2_entry(self, payload: dict | None = None) -> Any:
        ...
        """
        return self._adapter.post("ElectronicCommunicationActionService_AFE_FceAP_CheckECM2Entry", data=payload)
    ...
    def afe_fce_action_get_by_fce_id(self, payload: dict | None = None) -> Any:
        ...
        """
        return self._adapter.post("ElectronicCommunicationActionService_AFE_FceAction_GetByFceID", data=payload)
    ...
    def afe_fce_action_get_payment_data(self, payload: dict | None = None) -> Any:
        ...
        """
        return self._adapter.post("ElectronicCommunicationActionService_AFE_FceAction_GetPaymentData", data=payload)
    ...
    def afe_renumber_folio_numbers(self, payload: dict | None = None) -> Any:
        ...
        """
        return self._adapter.post("ElectronicCommunicationActionService_AFE_RenumberFolioNumbers", data=payload)
    ...
    def confirm_success_of_communication(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("ElectronicCommunicationActionService_ConfirmSuccessOfCommunication", data=payload)
    ...
    def get_action(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("ElectronicCommunicationActionService_GetAction", data=payload)
    ...
    def report_error_and_continue(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("ElectronicCommunicationActionService_ReportErrorAndContinue", data=payload)
    ...
    def report_error_and_stop(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("ElectronicCommunicationActionService_ReportErrorAndStop", data=payload)
    ...
    def update_action(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("ElectronicCommunicationActionService_UpdateAction", data=payload)
    ...
    def afe_fce_ap_get_latest_afip_date(self, params: dict | None = None) -> Any:
        ...
        """
        return self._function("ElectronicCommunicationActionService_AFE_FceAP_GetLatestAFIPDate", params)
    ...
    def afe_fce_ar_get_date_from_to(self, params: dict | None = None) -> Any:
        ...
        """
        return self._function("ElectronicCommunicationActionService_AFE_FceAR_GetDateFromTo", params)
    ...
    def afe_fce_ar_get_documents(self, params: dict | None = None) -> Any:
        ...
        """
        return self._function("ElectronicCommunicationActionService_AFE_FceAR_GetDocuments", params)
    ...
    def afe_upd_fce_apar_get_documents(self, params: dict | None = None) -> Any:
        ...
        """
        return self._function("ElectronicCommunicationActionService_AFE_UpdFceAPAR_GetDocuments", params)
