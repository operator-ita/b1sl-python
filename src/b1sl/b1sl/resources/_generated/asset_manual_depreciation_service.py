...
class AssetManualDepreciationService(GenericResource[Any]):
    ...
    def cancel(self, payload: dict | None = None) -> Any:
        ...
        ```
        """
        return self._adapter.post("AssetManualDepreciationService_Cancel", data=payload)
    ...
    def get_list(self, payload: dict | None = None) -> Any:
        ...
        """
        return self._adapter.post("AssetManualDepreciationService_GetList", data=payload)
