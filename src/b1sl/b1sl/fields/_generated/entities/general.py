...
class AssetDocumentFields(FieldEnum):
    ...
    asset_document_area_journal_collection = ODataField(
...
class ChecksforPaymentFields(FieldEnum):
    ...
    checksfor_payment_document_references = ODataField(
...
class CustomerEquipmentCardFields(FieldEnum):
    ...
    customer_equipment_card_business_partners = ODataField(
...
class DepreciationTypeFields(FieldEnum):
    ...
    subsequent_acquisition_period_control = ODataField(
    ...
    subsequent_acquisition_pro_rata_type = ODataField(
        "SubsequentAcquisitionProRataType"
    )
    retirement_pro_rata_type = ODataField("RetirementProRataType")
    percentage_of_depreciation_reversed_in_retirement_year = ODataField(
    ...
    straight_line_period_control_depreciation_periods = ODataField(
    ...
    special_depreciation_calculation_method = ODataField(
        "SpecialDepreciationCalculationMethod"
    )
    special_depreciation_concession_period_years = ODataField(
        "SpecialDepreciationConcessionPeriodYears"
    )
    special_depreciation_maximum_percentage = ODataField(
        "SpecialDepreciationMaximumPercentage"
    )
    special_depreciation_normal_depreciation = ODataField(
        "SpecialDepreciationNormalDepreciation"
    )
    special_depreciation_alternative_depreciation = ODataField(
        "SpecialDepreciationAlternativeDepreciation"
    )
    depreciation_type_pool = ODataField("DepreciationTypePool")
    manual_depreciation_reduce_depreciation_base = ODataField(
    ...
    include_previous_depreciation_in_capitalization_period = ODataField(
    ...
    factor_only_relevant_to_first_fiscal_year = ODataField(
...
class DocumentFields(FieldEnum):
    ...
    archive_nonremovable_sales_quotation = ODataField(
    ...
    reopen_manually_closed_or_canceled_document = ODataField(
    ...
    apply_current_vat_rates_for_down_payments_to_draw = ODataField(
    ...
    bpl_name = ODataField("BPLName")
    vat_reg_num = ODataField("VATRegNum")
    annual_invoice_declaration_reference = ODataField(
    ...
    date_of_reporting_control_statement_vat = ODataField(
    ...
    document_additional_intrastat_expenses = ODataField(
        "DocumentAdditionalIntrastatExpenses"
    )
...
class EmployeeInfoFields(FieldEnum):
    ...
    employee_previous_empoyment_info_lines = ODataField(
...
class HouseBankAccountFields(FieldEnum):
    ...
    no_validation_for_starting_ending_bal = ODataField(
...
class PaymentFields(FieldEnum):
    ...
    payment_document_references_collection = ODataField(
        "PaymentDocumentReferencesCollection"
    )
    bill_of_exchange = ODataField("BillOfExchange")
    withholding_tax_certificates_collection = ODataField(
...
class PaymentRunExportFields(FieldEnum):
    ...
    payment_bank_charges_allocation_code = ODataField(
...
class PurchaseTaxInvoiceFields(FieldEnum):
    ...
    purchase_tax_invoice_operation_codes = ODataField(
        "PurchaseTaxInvoiceOperationCodes"
    )
    purchase_tax_invoice_document_references = ODataField(
        "PurchaseTaxInvoiceDocumentReferences"
    )
    purchase_tax_invoice_linked_down_payments = ODataField(
...
class RecurringPostingsFields(FieldEnum):
    ...
    recurring_postings_document_reference_collection = ODataField(
...
class SalesTaxInvoiceFields(FieldEnum):
    ...
    sales_tax_invoice_document_references = ODataField(
        "SalesTaxInvoiceDocumentReferences"
    )
    sales_tax_invoice_linked_down_payments = ODataField(
...
class TaxReportFilterFields(FieldEnum):
    ...
    diplay_credit_memos_in_separate_column = ODataField(
...
class TransportationDocumentDataFields(FieldEnum):
    ...
    transportation_document_line_data_collection = ODataField(
...
class UserObjectsMDFields(FieldEnum):
    ...
    user_object_md_enhanced_form_columns = ODataField(
...
class WebClientListviewFilterFields(FieldEnum):
    ...
    web_client_listview_filter_conditions = ODataField(
...
class WebClientVariantFields(FieldEnum):
    ...
    web_client_variant_selected_column_collection = ODataField(
        "WebClientVariantSelectedColumnCollection"
    )
    web_client_variant_group_by_collection = ODataField(
        "WebClientVariantGroupByCollection"
    )
    web_client_variant_sort_by_collection = ODataField(
        "WebClientVariantSortByCollection"
    )
    web_client_variant_embedded_chart_collection = ODataField(
        "WebClientVariantEmbeddedChartCollection"
    )
    web_client_variant_m_chart_collection = ODataField(
