...
class LandedCost(B1Model):
    ...
    closed_document: LandedCostDocStatusEnumField | None = PydanticField(None, alias='ClosedDocument')
...
class LandedCostsCode(B1Model):
    ...
    allocation_by: BoAllocationByEnumField | None = PydanticField(None, alias='AllocationBy')
